...
public enum Settings {
    ...
    // AX: Fixed
    mouseb_strafe(FILE_DOOM, 1),
    // AX: Value inverted with the one above
    mouseb_forward(FILE_DOOM, 2),
    ...
    snd_musicdevice(FILE_DOOM, 3),
    // unused, here for compatibility
    snd_sfxdevice(FILE_DOOM, 3),
    // unused, here for compatibility
    snd_sbport(FILE_DOOM, 0),
    // unused, here for compatibility
    snd_sbirq(FILE_DOOM, 0),
    // unused, here for compatibility
    snd_sbdma(FILE_DOOM, 0),
    // unused, here for compatibility
    snd_mport(FILE_DOOM, 0),
