...
public class FinnwMusicModule implements IMusic {
    ...
    public FinnwMusicModule() {
        ...
        this.channels = new org.apache.commons.collections4.list.NodeCachingLinkedList<Channel>(15);
        this.songs = new org.apache.commons.collections4.list.NodeCachingLinkedList<Song>(1);
    ...
    public void PlaySong(int handle, boolean looping) {
        ...
        try {
            ...
            if (0 <= handle && handle < songs.size()) {
                ...
                currentTransmitter = new ScheduledTransmitter(song.getScoreBuffer(), looping);
    ...
    static boolean hasMusMagic(ByteBuffer magicBuf) {
        return magicBuf.get(0) == 'M' && magicBuf.get(1) == 'U' && magicBuf.get(2) == 'S' && magicBuf.get(3) == 0x1a;
    }
    ...
    static class EventGroup {
        ...
        EventGroup(float volScale) {
            this.messages = new org.apache.commons.collections4.list.TreeList<MidiMessage>();
